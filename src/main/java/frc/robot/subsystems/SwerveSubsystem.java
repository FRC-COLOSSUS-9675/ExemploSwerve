...
/////////////////////////////////////////////////////////////
  public Command alignInDegrees(DoubleSupplier yGamed, DoubleSupplier xGamepad, double  setPoint){
    return run(() -> {
      double angularVelocity = swerveDrive.swerveController.headingCalculate(getHeading().getRadians(), Units.degreesToRadians(setPoint));
      double vX = yGamed.getAsDouble() * swerveDrive.getMaximumChassisVelocity();
      double vY = xGamepad.getAsDouble() * swerveDrive.getMaximumChassisVelocity();
